...
#include <stdlib.h>
#include <time.h>
#include "TR67_535770.h" //isso deve ser mudado para o nome do arquivo com sua matricula.
...
int main(int argc, char** argv){
	...
	printf("Tempo de execusão da união: %f segundos \n", time_spent);
	...
	time_spent += (double)(end - begin) / CLOCKS_PER_SEC;
	printf("Tempo de execusão da intersecao: %f segundos \n", time_spent);
